...
import { getPhotography } from '../../../api/VendorsApi.jsx';
...
const PhotographyPage = () => {
    ...
    useEffect(() => {
        const fetchPhotographers = async () => {
            try {
                setLoading(true);
                const photographersData = await getPhotography();


                console.log("Complete API response:", photographersData);
                console.log("Photographer data:", photographersData.data);

                setPhotographers(photographersData.data);
            } catch (err) {
    ...
    if (loading) {
        return <h3>Loading photographers...</h3>;
    }
    ...
    const totalPages = Math.ceil(photographers.all.length / ITEMS_PER_PAGE);
    const paginatedPhotographers = photographers.all.slice(
            ...
            <div className="container-xl py-4">
                ...
                <div className="my-4">
                    ...
                    <div className="row g-3">
                        {photographers.recommended.slice(0,3).map((photographer) => (
                ...
                {/* ── All Venues Section ── */}
                <div>
                    <h5 className="section-heading mb-4">All Photographers in Karachi</h5>
                    <div className="row g-3">
