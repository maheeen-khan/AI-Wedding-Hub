...
export default function PhotographyPage() {
  const { id } = useParams();
  const vendor = id && id !== photographyData.id ? null : photographyData;
  ...
  return (
    <div className="vp-page">
      <Navbar breadcrumbLabel={vendor.breadcrumbLabel} breadcrumbHref="/vendors/photography" />
      ...
      <main className="vp-page__main">
        ...
        <div className="vp-page__full-width">
          <PackageTiers
            title={vendor.packageTiers.title}
            tiers={vendor.packageTiers.tiers}
          />
          <PortfolioGrid images={vendor.portfolioImages} />
